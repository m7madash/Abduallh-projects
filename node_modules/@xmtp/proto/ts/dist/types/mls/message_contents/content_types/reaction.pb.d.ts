...
export declare const ReactionV2: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): ReactionV2;
    fromJSON(object: any): ReactionV2;
    toJSON(message: ReactionV2): unknown;
    create<I extends Exact<DeepPartial<ReactionV2>, I>>(base?: I): ReactionV2;
    fromPartial<I extends Exact<DeepPartial<ReactionV2>, I>>(object: I): ReactionV2;
};
