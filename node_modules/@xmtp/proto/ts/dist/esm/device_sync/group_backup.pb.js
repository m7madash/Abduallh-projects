...
export const protobufPackage = "xmtp.device_sync.group_backup";
/** Definitions for backups */
/** Group membership state */
export var GroupMembershipStateSave;
(function (GroupMembershipStateSave) {
    ...
    GroupMembershipStateSave[GroupMembershipStateSave["GROUP_MEMBERSHIP_STATE_SAVE_PENDING_REMOVE"] = 5] = "GROUP_MEMBERSHIP_STATE_SAVE_PENDING_REMOVE";
    GroupMembershipStateSave[GroupMembershipStateSave["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(GroupMembershipStateSave || (GroupMembershipStateSave = {}));
export function groupMembershipStateSaveFromJSON(object) {
    switch (object) {
        case 0:
        ...
        case 5:
        case "GROUP_MEMBERSHIP_STATE_SAVE_PENDING_REMOVE":
            return GroupMembershipStateSave.GROUP_MEMBERSHIP_STATE_SAVE_PENDING_REMOVE;
        case -1:
        case "UNRECOGNIZED":
        default:
...
export function groupMembershipStateSaveToJSON(object) {
    switch (object) {
        ...
        case GroupMembershipStateSave.GROUP_MEMBERSHIP_STATE_SAVE_PENDING_REMOVE:
            return "GROUP_MEMBERSHIP_STATE_SAVE_PENDING_REMOVE";
...
/** Conversation type */
export var ConversationTypeSave;
...
})(ConversationTypeSave || (ConversationTypeSave = {}));
export function conversationTypeSaveFromJSON(object) {
    switch (object) {
        case 0:
...
export function conversationTypeSaveToJSON(object) {
    switch (object) {
...
function createBaseGroupSave() {
    return {
        id: new Uint8Array(0),
        createdAtNs: Long.ZERO,
        membershipState: 0,
        installationsLastChecked: Long.ZERO,
        addedByInboxId: "",
        welcomeId: undefined,
        rotatedAtNs: Long.ZERO,
        conversationType: 0,
        dmId: undefined,
...
export const GroupSave = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (!message.rotatedAtNs.equals(Long.ZERO)) {
        ...
        if (message.metadata !== undefined) {
            ImmutableMetadataSave.encode(message.metadata, writer.uint32(106).fork()).ldelim();
        }
        if (message.mutableMetadata !== undefined) {
            MutableMetadataSave.encode(message.mutableMetadata, writer.uint32(114).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 13:
                    ...
                    message.metadata = ImmutableMetadataSave.decode(reader, reader.uint32());
                    continue;
                case 14:
                    if (tag !== 114) {
                        break;
                    }
                    message.mutableMetadata = MutableMetadataSave.decode(reader, reader.uint32());
                    continue;
                case 15:
                    if (tag !== 122) {
                        break;
    ...
    fromJSON(object) {
        return {
            ...
            createdAtNs: isSet(object.createdAtNs) ? Long.fromValue(object.createdAtNs) : Long.ZERO,
            membershipState: isSet(object.membershipState) ? groupMembershipStateSaveFromJSON(object.membershipState) : 0,
            installationsLastChecked: isSet(object.installationsLastChecked)
                ? Long.fromValue(object.installationsLastChecked)
                : Long.ZERO,
            addedByInboxId: isSet(object.addedByInboxId) ? globalThis.String(object.addedByInboxId) : "",
            welcomeId: isSet(object.welcomeId) ? Long.fromValue(object.welcomeId) : undefined,
            rotatedAtNs: isSet(object.rotatedAtNs) ? Long.fromValue(object.rotatedAtNs) : Long.ZERO,
            conversationType: isSet(object.conversationType) ? conversationTypeSaveFromJSON(object.conversationType) : 0,
            dmId: isSet(object.dmId) ? globalThis.String(object.dmId) : undefined,
            lastMessageNs: isSet(object.lastMessageNs) ? Long.fromValue(object.lastMessageNs) : undefined,
            messageDisappearFromNs: isSet(object.messageDisappearFromNs)
                ? Long.fromValue(object.messageDisappearFromNs)
                : undefined,
            messageDisappearInNs: isSet(object.messageDisappearInNs)
                ? Long.fromValue(object.messageDisappearInNs)
                : undefined,
            metadata: isSet(object.metadata) ? ImmutableMetadataSave.fromJSON(object.metadata) : undefined,
            mutableMetadata: isSet(object.mutableMetadata) ? MutableMetadataSave.fromJSON(object.mutableMetadata) : undefined,
            pausedForVersion: isSet(object.pausedForVersion) ? globalThis.String(object.pausedForVersion) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (!message.createdAtNs.equals(Long.ZERO)) {
            obj.createdAtNs = (message.createdAtNs || Long.ZERO).toString();
        }
        if (message.membershipState !== 0) {
            obj.membershipState = groupMembershipStateSaveToJSON(message.membershipState);
        }
        if (!message.installationsLastChecked.equals(Long.ZERO)) {
            obj.installationsLastChecked = (message.installationsLastChecked || Long.ZERO).toString();
        }
        if (message.addedByInboxId !== "") {
            obj.addedByInboxId = message.addedByInboxId;
        }
        if (message.welcomeId !== undefined) {
            obj.welcomeId = (message.welcomeId || Long.ZERO).toString();
        }
        if (!message.rotatedAtNs.equals(Long.ZERO)) {
            obj.rotatedAtNs = (message.rotatedAtNs || Long.ZERO).toString();
        }
        if (message.conversationType !== 0) {
            obj.conversationType = conversationTypeSaveToJSON(message.conversationType);
        }
        if (message.dmId !== undefined) {
            obj.dmId = message.dmId;
        }
        if (message.lastMessageNs !== undefined) {
            obj.lastMessageNs = (message.lastMessageNs || Long.ZERO).toString();
        }
        if (message.messageDisappearFromNs !== undefined) {
            obj.messageDisappearFromNs = (message.messageDisappearFromNs || Long.ZERO).toString();
        }
        if (message.messageDisappearInNs !== undefined) {
            obj.messageDisappearInNs = (message.messageDisappearInNs || Long.ZERO).toString();
        }
        if (message.metadata !== undefined) {
            obj.metadata = ImmutableMetadataSave.toJSON(message.metadata);
        }
        if (message.mutableMetadata !== undefined) {
            obj.mutableMetadata = MutableMetadataSave.toJSON(message.mutableMetadata);
        }
        if (message.pausedForVersion !== undefined) {
    ...
    create(base) {
        return GroupSave.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGroupSave();
        message.id = object.id ?? new Uint8Array(0);
        message.createdAtNs = (object.createdAtNs !== undefined && object.createdAtNs !== null)
            ? Long.fromValue(object.createdAtNs)
            : Long.ZERO;
        message.membershipState = object.membershipState ?? 0;
        message.installationsLastChecked =
            (object.installationsLastChecked !== undefined && object.installationsLastChecked !== null)
                ? Long.fromValue(object.installationsLastChecked)
                : Long.ZERO;
        message.addedByInboxId = object.addedByInboxId ?? "";
        message.welcomeId = (object.welcomeId !== undefined && object.welcomeId !== null)
            ? Long.fromValue(object.welcomeId)
            : undefined;
        message.rotatedAtNs = (object.rotatedAtNs !== undefined && object.rotatedAtNs !== null)
            ? Long.fromValue(object.rotatedAtNs)
            : Long.ZERO;
        message.conversationType = object.conversationType ?? 0;
        message.dmId = object.dmId ?? undefined;
        message.lastMessageNs = (object.lastMessageNs !== undefined && object.lastMessageNs !== null)
            ? Long.fromValue(object.lastMessageNs)
            : undefined;
        message.messageDisappearFromNs =
            (object.messageDisappearFromNs !== undefined && object.messageDisappearFromNs !== null)
                ? Long.fromValue(object.messageDisappearFromNs)
                : undefined;
        message.messageDisappearInNs = (object.messageDisappearInNs !== undefined && object.messageDisappearInNs !== null)
            ? Long.fromValue(object.messageDisappearInNs)
            : undefined;
        message.metadata = (object.metadata !== undefined && object.metadata !== null)
            ? ImmutableMetadataSave.fromPartial(object.metadata)
            : undefined;
        message.mutableMetadata = (object.mutableMetadata !== undefined && object.mutableMetadata !== null)
            ? MutableMetadataSave.fromPartial(object.mutableMetadata)
            : undefined;
        message.pausedForVersion = object.pausedForVersion ?? undefined;
        return message;
    },
};
...
export const MutableMetadataSave = {
    encode(message, writer = _m0.Writer.create()) {
        Object.entries(message.attributes).forEach(([key, value]) => {
            MutableMetadataSave_AttributesEntry.encode({ key: key, value }, writer.uint32(10).fork()).ldelim();
        });
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    const entry1 = MutableMetadataSave_AttributesEntry.decode(reader, reader.uint32());
    ...
    fromJSON(object) {
        return {
            attributes: isObject(object.attributes)
                ...
                : {},
            adminList: globalThis.Array.isArray(object?.adminList)
                ? object.adminList.map((e) => globalThis.String(e))
                : [],
            superAdminList: globalThis.Array.isArray(object?.superAdminList)
                ? object.superAdminList.map((e) => globalThis.String(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.superAdminList?.length) {
            obj.superAdminList = message.superAdminList;
        }
        return obj;
    },
    create(base) {
        return MutableMetadataSave.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseMutableMetadataSave();
        ...
        message.superAdminList = object.superAdminList?.map((e) => e) || [];
        return message;
    },
};
...
export const MutableMetadataSave_AttributesEntry = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.key !== "") {
    ...
    create(base) {
        return MutableMetadataSave_AttributesEntry.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseMutableMetadataSave_AttributesEntry();
...
export const ImmutableMetadataSave = {
    encode(message, writer = _m0.Writer.create()) {
    ...
    fromJSON(object) {
        return { creatorInboxId: isSet(object.creatorInboxId) ? globalThis.String(object.creatorInboxId) : "" };
    },
    toJSON(message) {
        const obj = {};
        if (message.creatorInboxId !== "") {
    ...
    create(base) {
        return ImmutableMetadataSave.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseImmutableMetadataSave();
        message.creatorInboxId = object.creatorInboxId ?? "";
        return message;
    },
};
