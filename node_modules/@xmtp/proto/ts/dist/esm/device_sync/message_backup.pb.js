...
export const GroupMessageSave = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.contentTypeSave !== 0) {
            writer.uint32(72).int32(message.contentTypeSave);
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 9:
                    ...
                    message.contentTypeSave = reader.int32();
                    continue;
                case 10:
                    if (tag !== 80) {
                        break;
    ...
    fromJSON(object) {
        return {
            ...
            contentTypeSave: isSet(object.contentTypeSave) ? contentTypeSaveFromJSON(object.contentTypeSave) : 0,
    ...
    toJSON(message) {
        ...
        if (message.contentTypeSave !== 0) {
            obj.contentTypeSave = contentTypeSaveToJSON(message.contentTypeSave);
        }
        if (message.versionMajor !== 0) {
    ...
    fromPartial(object) {
        ...
        message.contentTypeSave = object.contentTypeSave ?? 0;
