...
export const EnumSchema = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.externalDocs !== undefined) {
            ExternalDocumentation.encode(message.externalDocs, writer.uint32(50).fork()).ldelim();
        }
        if (message.example !== "") {
        ...
        Object.entries(message.extensions).forEach(([key, value]) => {
            if (value !== undefined) {
                EnumSchema_ExtensionsEntry.encode({ key: key, value }, writer.uint32(74).fork()).ldelim();
            }
        });
        return writer;
    },
...
export const SecurityRequirement = {
    encode(message, writer = _m0.Writer.create()) {
        Object.entries(message.securityRequirement).forEach(([key, value]) => {
            SecurityRequirement_SecurityRequirementEntry.encode({ key: key, value }, writer.uint32(10).fork())
                .ldelim();
        });
        return writer;
    },
