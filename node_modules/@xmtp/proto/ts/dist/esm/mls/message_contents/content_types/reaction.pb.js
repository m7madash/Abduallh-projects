...
export function reactionActionFromJSON(object) {
    switch (object) {
        case 0:
...
export function reactionActionToJSON(object) {
    switch (object) {
...
export function reactionSchemaFromJSON(object) {
    switch (object) {
        case 0:
...
export function reactionSchemaToJSON(object) {
    switch (object) {
...
function createBaseReactionV2() {
    return { reference: "", referenceInboxId: "", action: 0, content: "", schema: 0 };
}
export const ReactionV2 = {
    ...
    fromJSON(object) {
        return {
            ...
            referenceInboxId: isSet(object.referenceInboxId) ? globalThis.String(object.referenceInboxId) : "",
    ...
    create(base) {
        return ReactionV2.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseReactionV2();
        message.reference = object.reference ?? "";
        message.referenceInboxId = object.referenceInboxId ?? "";
