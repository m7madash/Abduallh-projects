...
exports.ConsentSave = exports.ConsentStateSave = exports.ConsentTypeSave = exports.protobufPackage = void 0;
exports.consentTypeSaveFromJSON = consentTypeSaveFromJSON;
exports.consentTypeSaveToJSON = consentTypeSaveToJSON;
exports.consentStateSaveFromJSON = consentStateSaveFromJSON;
exports.consentStateSaveToJSON = consentStateSaveToJSON;
/* eslint-disable */
const long_1 = __importDefault(require("long"));
const minimal_1 = __importDefault(require("protobufjs/minimal"));
exports.protobufPackage = "xmtp.device_sync.consent_backup";
...
})(ConsentTypeSave || (exports.ConsentTypeSave = ConsentTypeSave = {}));
function consentTypeSaveFromJSON(object) {
    switch (object) {
        case 0:
...
function consentTypeSaveToJSON(object) {
    switch (object) {
...
})(ConsentStateSave || (exports.ConsentStateSave = ConsentStateSave = {}));
function consentStateSaveFromJSON(object) {
    switch (object) {
        case 0:
...
function consentStateSaveToJSON(object) {
    switch (object) {
...
function createBaseConsentSave() {
    return { entityType: 0, state: 0, entity: "", consentedAtNs: long_1.default.ZERO };
}
exports.ConsentSave = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (!message.consentedAtNs.equals(long_1.default.ZERO)) {
    ...
    fromJSON(object) {
        return {
            entityType: isSet(object.entityType) ? consentTypeSaveFromJSON(object.entityType) : 0,
            state: isSet(object.state) ? consentStateSaveFromJSON(object.state) : 0,
            entity: isSet(object.entity) ? globalThis.String(object.entity) : "",
            consentedAtNs: isSet(object.consentedAtNs) ? long_1.default.fromValue(object.consentedAtNs) : long_1.default.ZERO,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (!message.consentedAtNs.equals(long_1.default.ZERO)) {
            obj.consentedAtNs = (message.consentedAtNs || long_1.default.ZERO).toString();
        }
        return obj;
    },
    create(base) {
        return exports.ConsentSave.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseConsentSave();
        ...
        message.consentedAtNs = (object.consentedAtNs !== undefined && object.consentedAtNs !== null)
            ? long_1.default.fromValue(object.consentedAtNs)
            : long_1.default.ZERO;
        return message;
    },
};
