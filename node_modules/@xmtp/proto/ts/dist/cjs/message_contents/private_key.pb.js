...
exports.SignedPrivateKey = {
    ...
    fromJSON(object) {
        return {
            ...
            secp256k1: isSet(object.secp256k1) ? exports.SignedPrivateKey_Secp256k1.fromJSON(object.secp256k1) : undefined,
            publicKey: isSet(object.publicKey) ? public_key_pb_1.SignedPublicKey.fromJSON(object.publicKey) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.secp256k1 !== undefined) {
            obj.secp256k1 = exports.SignedPrivateKey_Secp256k1.toJSON(message.secp256k1);
        }
        if (message.publicKey !== undefined) {
            obj.publicKey = public_key_pb_1.SignedPublicKey.toJSON(message.publicKey);
        }
        return obj;
    },
    create(base) {
        return exports.SignedPrivateKey.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSignedPrivateKey();
...
exports.SignedPrivateKey_Secp256k1 = {
    ...
    create(base) {
        return exports.SignedPrivateKey_Secp256k1.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSignedPrivateKey_Secp256k1();
...
exports.PrivateKeyBundleV2 = {
    ...
    fromJSON(object) {
        return {
            identityKey: isSet(object.identityKey) ? exports.SignedPrivateKey.fromJSON(object.identityKey) : undefined,
    ...
    toJSON(message) {
        const obj = {};
        if (message.identityKey !== undefined) {
            obj.identityKey = exports.SignedPrivateKey.toJSON(message.identityKey);
        }
        if (message.preKeys?.length) {
            obj.preKeys = message.preKeys.map((e) => exports.SignedPrivateKey.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return exports.PrivateKeyBundleV2.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBasePrivateKeyBundleV2();
        message.identityKey = (object.identityKey !== undefined && object.identityKey !== null)
            ...
            : undefined;
        message.preKeys = object.preKeys?.map((e) => exports.SignedPrivateKey.fromPartial(e)) || [];
        return message;
    },
};
...
exports.PrivateKey = {
    ...
    fromJSON(object) {
        return {
            ...
            secp256k1: isSet(object.secp256k1) ? exports.PrivateKey_Secp256k1.fromJSON(object.secp256k1) : undefined,
            publicKey: isSet(object.publicKey) ? public_key_pb_1.PublicKey.fromJSON(object.publicKey) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.secp256k1 !== undefined) {
            obj.secp256k1 = exports.PrivateKey_Secp256k1.toJSON(message.secp256k1);
        }
        if (message.publicKey !== undefined) {
            obj.publicKey = public_key_pb_1.PublicKey.toJSON(message.publicKey);
        }
        return obj;
    },
    create(base) {
        return exports.PrivateKey.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBasePrivateKey();
...
exports.PrivateKey_Secp256k1 = {
    ...
    create(base) {
        return exports.PrivateKey_Secp256k1.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBasePrivateKey_Secp256k1();
        message.bytes = object.bytes ?? new Uint8Array(0);
...
exports.PrivateKeyBundleV1 = {
    ...
    fromJSON(object) {
        return {
            identityKey: isSet(object.identityKey) ? exports.PrivateKey.fromJSON(object.identityKey) : undefined,
            preKeys: globalThis.Array.isArray(object?.preKeys) ? object.preKeys.map((e) => exports.PrivateKey.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
        if (message.identityKey !== undefined) {
            obj.identityKey = exports.PrivateKey.toJSON(message.identityKey);
        }
        if (message.preKeys?.length) {
            obj.preKeys = message.preKeys.map((e) => exports.PrivateKey.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return exports.PrivateKeyBundleV1.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBasePrivateKeyBundleV1();
        message.identityKey = (object.identityKey !== undefined && object.identityKey !== null)
            ...
            : undefined;
        message.preKeys = object.preKeys?.map((e) => exports.PrivateKey.fromPartial(e)) || [];
        return message;
    },
};
...
exports.PrivateKeyBundle = {
    ...
    toJSON(message) {
        const obj = {};
        if (message.v1 !== undefined) {
            obj.v1 = exports.PrivateKeyBundleV1.toJSON(message.v1);
        }
        if (message.v2 !== undefined) {
            obj.v2 = exports.PrivateKeyBundleV2.toJSON(message.v2);
        }
        return obj;
    },
    create(base) {
        return exports.PrivateKeyBundle.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBasePrivateKeyBundle();
...
exports.EncryptedPrivateKeyBundleV1 = {
    ...
    fromJSON(object) {
        return {
            ...
            ciphertext: isSet(object.ciphertext) ? ciphertext_pb_1.Ciphertext.fromJSON(object.ciphertext) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.ciphertext !== undefined) {
            obj.ciphertext = ciphertext_pb_1.Ciphertext.toJSON(message.ciphertext);
        }
        return obj;
    },
    create(base) {
        return exports.EncryptedPrivateKeyBundleV1.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseEncryptedPrivateKeyBundleV1();
...
exports.EncryptedPrivateKeyBundle = {
    ...
    fromJSON(object) {
        return { v1: isSet(object.v1) ? exports.EncryptedPrivateKeyBundleV1.fromJSON(object.v1) : undefined };
    },
    toJSON(message) {
        const obj = {};
        if (message.v1 !== undefined) {
            obj.v1 = exports.EncryptedPrivateKeyBundleV1.toJSON(message.v1);
        }
        return obj;
    },
    create(base) {
        return exports.EncryptedPrivateKeyBundle.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseEncryptedPrivateKeyBundle();
        message.v1 = (object.v1 !== undefined && object.v1 !== null)
