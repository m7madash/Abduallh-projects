...
exports.UninterpretedOption = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.positiveIntValue !== undefined && !message.positiveIntValue.equals(long_1.default.UZERO)) {
            writer.uint32(32).uint64(message.positiveIntValue);
        }
        if (message.negativeIntValue !== undefined && !message.negativeIntValue.equals(long_1.default.ZERO)) {
